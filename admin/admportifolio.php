                            ...
                            <div class="content">
                                <section class="bt-line">
                                    <h3 class="title">Portifólio</h3>
                                        ...
                                        <div class="row pt-adm">
                                                <div class="col-lg-2 col-md-2"></div>    
                                                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                    <div class="panel panel-default">
                                                      <div class="panel-heading"><h1 class=""><?php echo $row['titulo']; ?></h1></div>
                                                      <div class="panel-body">
                                                        <div class="pt-img center"><img class="img-responsive img-thumbnail" src="../img/uploads/<?php echo $row['nome'];?>"></div>
                                                      </div>
                                                      <div class="panel-body">
                                         ...
                                         <?php }?>  
                                            <div class="row">    
                                                ...
                                                <div class="col-lg-4 col-md-4">
                                                    <button type="button" class="btn btn-info btn-lg btn-adm" data-toggle="modal" data-target="#myModalPortifolio">Gerenciar</button>
                                                </div>
                                                <div class="col-lg-4 col-md-4"></div>
                                            </div>    
                                </section>
...
<div class="container">
    <div class="modal fade" id="myModalPortifolio" role="dialog">
        <div class="modal-dialog">
          <!-- Modal content-->
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal">&times;</button>
              <h4 class="modal-title">Gerenciar Portifolio</h4>
            </div>
            <div class="modal-body">
            <div class="row">    
                <div class="col-lg-3 col-md-3"></div>
                <div class="col-lg-3 col-md-3 center"><button class="adm-btn btn btn-success" type="button" onclick="load_img_portifolio()">Adicionar</button></div>
                <div class="col-lg-3 col-md-3 center"><button class="adm-btn btn btn-danger" type="button" onclick="delete_img_portifolio()">Deletar</button></div>
                <div class="col-lg-3 col-md-3"></div>
            </div>    
