...
<HTML>
    ...
    $do = $db->exec("INSERT INTO textos (fk_tipo, conteudo, titulo, fk_pag) VALUES (4, '$box', NULL,1)");
    ...
    <div class="col-lg-6 col-md-6 col-sm-8">
        <form method="POST" action="salvarBox3.php" enctype="multipart/form-data">
            <fieldset class="input-margem">
                <label for="box">Box 3:</label>
