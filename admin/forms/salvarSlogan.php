...
<HTML>
    ...
    $do = $db->exec("INSERT INTO textos (fk_tipo, conteudo, titulo, fk_pag) VALUES (1, '$slogan', NULL,1)");
    ...
    <div class="col-lg-6 col-md-6 col-sm-8">
        <form method="POST" action="salvarSlogan.php" enctype="multipart/form-data">
            <fieldset class="input-margem">
                <label for="slogan">Slogan:</label>
                <input type="text" name="slogan" class="form-control" placeholder="entre com um texto..." required>
            </fieldset>
            </br>
            <fieldset class="input-margem">
