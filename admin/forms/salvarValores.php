...
<HTML>
    ...
    $do = $db->exec("INSERT INTO textos (fk_tipo, conteudo, titulo, fk_pag) VALUES (9, '$slogan', NULL,2)");
    ...
    <div class="col-lg-6 col-md-6 col-sm-8">
        <form method="POST" action="salvarValores.php" enctype="multipart/form-data">
            <fieldset class="input-margem">
                <label for="slogan">Valores da Expresse:</label>
