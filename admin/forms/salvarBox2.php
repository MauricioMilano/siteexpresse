...
<HTML>
    ...
    <div class="adm-alert col-lg-12 col-md-12">
        ...
        $do = $db->exec("INSERT INTO textos (fk_tipo, conteudo, titulo, fk_pag) VALUES (3, '$box', NULL,1)");
    ...
    <div class="col-lg-6 col-md-6 col-sm-8">
        <form method="POST" action="salvarBox2.php" enctype="multipart/form-data">
            <fieldset class="input-margem">
                <label for="box">Box 2:</label>
                <textarea class="form-control" name="box" id="box" rows="8" placeholder="texto..." required></textarea>
            </fieldset>
            </br>
            <fieldset class="input-margem">
