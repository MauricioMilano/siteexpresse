	    ...
	    <div class="row">
	    	<div class="table-responsive">
		    	<table class="table table-bordered">
		            ...
		            <tbody>
		                <?php 
							foreach ($db->query("SELECT conteudo, id_texto FROM textos WHERE textos.fk_tipo = 4") as $row){ ?>
							<tr>
								<td>
			...
			<form method="POST" action="deletarBox3.php" enctype="multipart/form-data">
			    <fieldset>
